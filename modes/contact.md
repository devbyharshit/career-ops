...
3. **Select primary target**: the person who would most benefit from the candidate being there
...
4. **Generate message** with a 3-sentence framework adapted to the contact type:
   ...
   ### Hiring Manager
   - **Sentence 1 (Hook)**: Specific challenge their team is facing (extracted from JD, company blog, or news)
   - **Sentence 2 (Proof)**: Candidate's biggest quantifiable achievement showing they have solved similar problems
   ...
   - **Note**: DO NOT ask for a job. The referral will happen naturally if the conversation flows.

   ### Interviewer (pre-interview)
   - **Sentence 1 (Research)**: Reference to something specific about their work or trajectory
